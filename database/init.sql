...
CREATE TYPE tipo_emum AS ENUM ('Consulta', 'Movimiento', 'Prestamo');
...
CREATE TABLE IF NOT EXISTS Interacciones(
    ...
    tipo tipo_emum NOT NULL DEFAULT 'Consulta',
...
CREATE TABLE IF NOT EXISTS Movimientos(
    ...
    conepto TEXT NOT NULL DEFAULT 'Sin concepto',
...
CREATE INDEX idx_prestamo ON Cuenta (cedula);
